        ...
        <div className="default aboutPage">
          ...
          <div className="aboutParagraph">
            ...
            <p>
              ...
              precedence in my day to day life. In an effort to better myself
              for a healthier lifestyle and help others <i>Meal Plan</i> was
              created! I hope this helps you as much as it will help me!
              <br />
              <br />
            </p>
            <p> -Blessings-</p>
